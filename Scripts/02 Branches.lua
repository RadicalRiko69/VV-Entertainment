...
Branch = {
	...
	AfterGameplay = function()
		--[[ DO NOT ENABLE!!!!
		local dead = STATSMAN:GetCurStageStats():AllFailed()
		if GAMESTATE:IsEventMode() == false and dead then
			return "ScreenExit"
		end]]--
	...
	AfterEvaluation = function()
		if GAMESTATE:IsCourseMode() then
			...
			if GAMESTATE:IsEventMode() or stagesLeft >= 1 then
				return "ScreenProfileSave"
			elseif GAMESTATE:IsEventMode() == false then
				return "ScreenTitleJoin"
